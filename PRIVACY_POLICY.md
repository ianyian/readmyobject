...
- ❌ No location data
- ❌ No camera images or videos sent to external servers
...
- ❌ No payment processors (app is self-contained)
...
Changes are effective immediately upon posting. Continued use of the app after changes constitutes acceptance of the updated policy.
...
While we don't collect data, we ensure:

- All processing happens securely on-device
- Camera permissions follow iOS security guidelines
- Photo library access is limited to user-selected images
...
- **App Support**: [your-support-email@example.com]
...
Since no data is collected, transmitted, or stored externally, the app poses no privacy risk.

## Summary

**In Plain English:**

✅ Your camera feed is processed on your device only  
